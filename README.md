...
- **Support** shows copyable diagnostics for bug reports.
...
There is no bundler or test runner in this version.
...
Light Reader stores settings in Chrome sync storage:
...
- Some sites with aggressive CSS, iframes, or closed shadow DOM may not fully inherit Light Reader styles.
